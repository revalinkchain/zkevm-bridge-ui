...
import { ReactComponent as PolygonZkEVMLogo } from "src/assets/reva-zkevm-logo.svg";
        ...
        <ConfirmationModal
          message={
            <Typography type="body1">
              DISCLAIMER: This version of the RevaLink zkEVM will require frequent maintenance and
